...
(def keyboard-keys [{:cocoa-key-code 0  :java-key-code 65       :finger 0 :class :home       :row 1 :column 0  :qwerty-character "a" :disabled? false}
                    ...
                    {:cocoa-key-code 4  :java-key-code 72       :finger 4 :class :sideways   :row 1 :column 5  :qwerty-character "h" :disabled? false}
                    {:cocoa-key-code 5  :java-key-code 71       :finger 3 :class :sideways   :row 1 :column 4  :qwerty-character "g" :disabled? false}
                    {:cocoa-key-code 6  :java-key-code 90       :finger 1 :class :curl       :row 2 :column 1  :qwerty-character "z" :disabled? false}
                    {:cocoa-key-code 7  :java-key-code 88       :finger 2 :class :curl       :row 2 :column 2  :qwerty-character "x" :disabled? false}
                    ...
                    {:cocoa-key-code 12 :java-key-code 81       :finger 0 :class :sideways   :row 0 :column 0  :qwerty-character "q" :disabled? false}
                    ...
                    {:cocoa-key-code 33 :java-key-code 91       :finger 7 :class :sideways   :row 0 :column 10 :qwerty-character "å" :disabled? false}
                    ...
                    {:cocoa-key-code 39 :java-key-code 222      :finger 7 :class :sideways   :row 1 :column 10 :qwerty-character "ä" :disabled? false}
                    ...
                    {:cocoa-key-code 43 :java-key-code 44       :finger 5 :class :curl       :row 2 :column 7  :qwerty-character "," :disabled? true}
                    {:cocoa-key-code 44 :java-key-code 47       :finger 7 :class :curl       :row 2 :column 9  :qwerty-character "-" :disabled? true}
                    {:cocoa-key-code 45 :java-key-code 78       :finger 4 :class :sideways   :row 2 :column 5  :qwerty-character "n" :disabled? false}
                    {:cocoa-key-code 46 :java-key-code 77       :finger 4 :class :easy-index :row 2 :column 6  :qwerty-character "m" :disabled? false}
                    {:cocoa-key-code 47 :java-key-code 46       :finger 6 :class :curl       :row 2 :column 8  :qwerty-character "." :disabled? true}
                    {:cocoa-key-code 50 :java-key-code 192      :finger 0 :class :curl       :row 2 :column 0  :qwerty-character "<" :disabled? true}])
