...
(def xaei {:layout
           #{{:cocoa-key-code 1, :character "s"}
             ...
             {:cocoa-key-code 14, :character "b"}
             {:cocoa-key-code 3, :character "t"}
             {:cocoa-key-code 9, :character "v"}
             {:cocoa-key-code 38, :character "a"}
             {:cocoa-key-code 8, :character "d"}
           ...
           :name "xaei",
           :description
           "more weight for key type and appreciate curling keys, fixed n-key hand in rating"})
